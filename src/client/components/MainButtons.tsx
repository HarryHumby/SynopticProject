...
export default class MainButtons extends Component {
  render() {
    ...
    if (this.props.playlistSize > 1) {
      shuffleButton = <button disabled={this.props.disabled} className="shuffle-button" title="Shuffle" onClick={this.props.randomSong}><i className="fa fa-random"></i></button>
    }

    return (<div className="main-button-holder">
      <button disabled={this.props.disabled} className="previous-button" title="Previous" onClick={this.props.previousSong}><i className="fa fa-step-backward"></i></button>
      ...
      <button disabled={this.props.disabled} className="next-button" title="Next" onClick={this.props.nextSong}><i className="fa fa-step-forward"></i></button>
      {shuffleButton}
